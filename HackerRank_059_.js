function minimumDistances(a) {
    ...
    for (let i = 0; i < loopCount; i++) {
            let findIndex = matchingItemIndex(i, a);
        if (findIndex != 0) {
